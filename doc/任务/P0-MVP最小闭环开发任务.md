...
| P0-B04 敌人基础 AI | ✅ 已完成 | [P0-B04-敌人基础AI](../P0-B04-敌人基础AI/README.md) · [源码与函数说明](../P0-B04-敌人基础AI/源码与函数说明.md) |
| P0-B05 死亡重开 + P0-L02 状态机 | ✅ 已完成 | [P0-B05+L02-死亡重开与关卡状态机](../P0-B05+L02-死亡重开与关卡状态机/README.md) · [源码与函数说明](../P0-B05+L02-死亡重开与关卡状态机/源码与函数说明.md) |
| P0-L03 结算与叙事占位 | ✅ 已完成 | [P0-L03-结算与叙事占位](../P0-L03-结算与叙事占位/README.md) · [源码与函数说明](../P0-L03-结算与叙事占位/源码与函数说明.md) |
| P0-B06 伤害与碰撞层整理 | ✅ 已完成 | [P0-B06-伤害与碰撞层整理](../P0-B06-伤害与碰撞层整理/README.md) |
| P0-L07 MVP 联调与走测 | ✅ 已完成 | [P0-L07-MVP联调与走测](../P0-L07-MVP联调与走测/README.md) |
| P0-L04 ~ L06 | ⏸ v0.2 | — |
...
- [x] **B06-1** 对照上表检查 `player.tscn`、`enemy.tscn`、`bullet.tscn`、`level1.tscn` 碰撞配置
- [x] **B06-2** 修复子弹命中玩家、敌人穿墙等异常（联调已验证；显式补全 Player layer）
- [x] **B06-3** 在 `constants.hpp` 或本任务文档旁注碰撞矩阵（便于后续技能扩展）
- [x] **B06-4** 回归测试：射击、受击、撞墙、伤害区全流程
...
> 详细记录见 [P0-L07-MVP联调与走测](../P0-L07-MVP联调与走测/README.md)
...
> 以下任务**不纳入 v0.1 最小闭环**。详细子任务、DoD 与走测见 **[P0-v0.2-视觉与性能开发任务](./P0-v0.2-视觉与性能开发任务.md)** · [v0.2定义与验收标准](../v0.2定义与验收标准.md)。

| 任务 | 预估 | 说明 |
|------|------|------|
| P0-L04 视差森林背景 | 2–3 天 | 2–3 层 ParallaxBackground |
| P0-L06 占位美术资源整理 | 1–2 天 | 统一 sprite，辨识玩家/敌人/背景 |
| P0-L05 对象池 | 2–3 天 | 同屏 10 敌 + 20 弹 |
| P0-L08 v0.2 联调走测 | 1 天 | v0.2 出口 |
...
| [P0-B04 实现文档](../P0-B04-敌人基础AI/README.md) | 已完成参考 |
| [P0-B04 源码与函数说明](../P0-B04-敌人基础AI/源码与函数说明.md) | 逐函数说明 |
| [P0-B06 实现文档](../P0-B06-伤害与碰撞层整理/README.md) | 碰撞矩阵 |
| [P0-B06 源码与函数说明](../P0-B06-伤害与碰撞层整理/源码与函数说明.md) | 逐函数说明 |
| [P0-L07 走测记录](../P0-L07-MVP联调与走测/README.md) | v0.1 验收 |
| [P0-v0.2-视觉与性能开发任务](./P0-v0.2-视觉与性能开发任务.md) | **v0.2 推荐执行顺序** |
| [v0.2定义与验收标准](../v0.2定义与验收标准.md) | v0.2 范围与检查清单 |
| [P1-技能氛围与八字开发任务](./P1-技能氛围与八字开发任务.md) | v0.2 完成后 P1 路线图 |
